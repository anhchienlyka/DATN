...
namespace WebBanMayAnh.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(DATNContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public ActionResult Index(int? page)
        {
            ...
            var pageSize = 10;
            var listCustomer = _context.Customers.AsNoTracking().Include(x => x.Location).OrderByDescending(x => x.CustomerID);
